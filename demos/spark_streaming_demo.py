...
def run_spark_streaming_job():
    ...
    spark = (
        SparkSession.builder.appName("RetailSalesVelocity")
    ...
    sales_velocity = (
        sales_stream.withWatermark("timestamp", "10 minutes")  # Handle late data
        .groupBy(
            col("product_id"),
            col("store_id"),
    ...
    query = (
        ...
        .writeStream.outputMode("update")  # Use update mode for aggregations
        .format("kafka")
        .option("kafka.bootstrap.servers", KAFKA_BROKERS)
