...
from tests.mocks import (
    MockAsyncOpenAI,
)  # Keep using this if it provides helpful defaults
...
async def test_generate_agent_response_success(mock_safe_completion):
    ...
    # mock_client.__class__ = AsyncOpenAI
    # Or mock_client = MagicMock(spec=AsyncOpenAI, wraps=MockAsyncOpenAI())
