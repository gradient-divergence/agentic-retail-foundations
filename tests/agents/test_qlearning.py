...
def test_choose_action_explore(mock_choice, mock_random, q_agent: QLearningAgent):
...
def test_choose_action_exploit(mock_random, q_agent: QLearningAgent):
...
def test_choose_action_exploit_tie_breaking(mock_choice, mock_random, q_agent: QLearningAgent):
...
@patch("numpy.random.random")
def test_choose_action_exploit_with_unavailable_action(mock_random, q_agent: QLearningAgent):
