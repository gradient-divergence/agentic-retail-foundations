...
async def test_safe_chat_completion_retry_on_failure(caplog):
    ...
    with patch('asyncio.sleep', new_callable=AsyncMock) as mock_sleep, \
         caplog.at_level(logging.WARNING): # Capture warning logs
    ...
    # Ensure no success DEBUG log was emitted by checking number of records or specific content
    # (Assuming the test logger doesn't capture the DEBUG log from the original function)
