...
class EventBus:
    ...
    def subscribe(self, event_type: str, callback: Callable[[RetailEvent], Coroutine[Any, Any, None]]) -> None:
    ...
    def unsubscribe(self, event_type: str, callback: Callable[[RetailEvent], Coroutine[Any, Any, None]]) -> None:
            ...
            if tasks:
                 ...
                 for i, result in enumerate(results):
                     if isinstance(result, Exception):
                         ...
                         logger_event_bus.error(f"Error in subscriber callback '{callback_name}' for event {event.event_type}: {result}", exc_info=False) 